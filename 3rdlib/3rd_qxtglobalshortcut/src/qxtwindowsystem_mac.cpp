...
QString QxtWindowSystem::windowTitle(WId window)
{
    ...
    // converting strings to/from CGSValue was dropped in 10.5, I use CFString,
...
uint QxtWindowSystem::idleTime()
{
    ...
    double idle =
        1000 * ::CGEventSourceSecondsSinceLastEventType(kCGEventSourceStateCombinedSessionState, kCGAnyInputEventType);
    return (uint)idle;
}
