...
void
ShowMessage(const std::u8string& title, const std::u8string& text, int type)
{
  switch (type) {
    case 0:
...
main(int argc, char* argv[])
{
  ...
  a.setQuitOnLastWindowClosed(
    false); // 防止QFileDialog被当成最主窗口导致程序结束
  VarBox box;
