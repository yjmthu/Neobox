...
- 发布信息
  * Qt5编写
  * 适用于64位的win10系统。
- 下载地址 ——  **此为旧版本，可能会有一些小问题，功能也有很多不足，推荐下载最下面的最新版**
...
- 更新内容
  * 采用最新的Qt6编写
  * **可以通过检查GitHub进行自动更新了！** 访问github可能比较慢，因此检查更新和下载更新的过程中可能会出现界面卡顿，不是bug，耐心等待几秒即可，如果可以更新，下载更新按钮将会自动解除禁用。
  * 修复翻译出错的Bug。
  * 由于必应首页的源码进行了重构，所以**以前的版本不能使用必应壁纸了** 。因此这个版本更新了必应壁纸。
  * 改变了界面样式。
  * 优化了一些代码，提高了效率节约内存。
- 下载地址 （64位Windows 10）
...
- 下载方式
  * 如果已经下载了21.9.10版本，在"右键菜单->软件设置->其他设置->关于"中点击"下载更新"按钮即可完成更新，如果没有下载21.9.10版本请先下载后再操作。
***
