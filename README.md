...
## [划词翻译]
* 如果你在启用了翻译功能，就需要输入百度翻译的app id和密码。我这里暂时提供一个APP ID：**20210503000812254**，密钥：**Q_2PPxmCr66r6B2hi0ts**。注册一个ID是免费的，大家不嫌麻烦的话可以自己去[注册](http://api.fanyi.baidu.com/)。
