...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PathDialog_t, stringdata0) + ofs \
...
QT_INIT_METAOBJECT const QMetaObject PathDialog::staticMetaObject = { {
    QMetaObject::SuperData::link<QDialog::staticMetaObject>(),
    qt_meta_stringdata_PathDialog.data,
    qt_meta_data_PathDialog,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *PathDialog::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PathDialog.stringdata0))
